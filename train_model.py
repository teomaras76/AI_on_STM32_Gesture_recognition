...
parser.add_argument('--data_raw', default = "C:\\Matteo\\Gesture demo\\Dataset original\\ODR 52Hz", type= str,
                    help='path to RAW log file')
parser.add_argument('--data_proc', default = "C:\\Matteo\\Gesture demo\\Processed\\ODR 52Hz", type= str,
                    help='path to processed dataset')
parser.add_argument('--log_path', default = "C:\\Matteo\\Gesture demo\\Train log", type= str,
                    help='path to processed dataset')
...
parser.add_argument('--n_cells', default=64, type=int,
                    help='number of GRU cells for layer (default: 256)')
parser.add_argument('--n_layers', default=2, type=int,
                    help='number of layers (default: 4)')
parser.add_argument('--seq_length', type=int, default=128)
parser.add_argument('-n', '--n_classes', default=10, type=int,      # To fix later 9 classes instead of 0 (class=0 not used)
...
x_train, x_test, y_train, y_test = split_dataset(X, Y, 80, True)
...
for i in range(args.epochs):
    ...
    hist = model.fit(x_train, y_train, batch_size=args.batch_size, verbose=1, epochs=1, validation_split=0.2)
